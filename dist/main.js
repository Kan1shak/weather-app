...
}`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;IACI,SAAS;IACT,UAAU;IACV,sBAAsB;AAC1B;AACA;IACI,YAAY;IACZ,aAAa;IACb,aAAa;IACb,uBAAuB;IACvB,mBAAmB;IACnB,kBAAkB;AACtB;;AAEA;IACI,WAAW;IACX,YAAY;IACZ,iBAAiB;IACjB,uBAAuB;IACvB,+BAA+B;IAC/B,UAAU;IACV,WAAW;IACX,kBAAkB;IAClB,yDAA4L;AAChM;;AAEA;IACI,UAAU;IACV,WAAW;AACf;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,qBAAqB;AACzB;;;AAGA;CACC;EACC,UAAU;CACX;CACA;EACC,UAAU;CACX;CACA;EACC,UAAU;CACX;CACA;EACC,UAAU;CACX;AACD","sourcesContent":["* {\n    margin: 0;\n    padding: 0;\n    box-sizing: border-box;\n}\n.container {\n    width: 100vw;\n    height: 100vh;\n    display: flex;\n    justify-content: center;\n    align-items: center;\n    position: relative;\n}\n\n.bg-image {\n    width: 100%;\n    height: 100%;\n    object-fit: cover;\n    /* filter: blur(5px); */\n    /* -webkit-filter: blur(5px); */\n    opacity: 1;\n    z-index: -1;\n    position: absolute;\n    filter: blur(5px) url('data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\"><filter id=\"a\"><feComponentTransfer><feFuncA type=\"linear\" slope=\"10\"/></feComponentTransfer></filter>#a');\n}\n\n.bg-image.previous {\n    opacity: 0;\n    z-index: -2;\n}\n\n.main-container {\n    user-select: none;\n}\n\n.fade-out {\n    animation: fade 1s 1 ;\n}\n\n\n@keyframes fade {\n\t0% {\n\t\topacity: 1;\n\t}\n\t25% {\n\t\topacity: 1;\n\t}\n\t75% {\n\t\topacity: 0;\n\t}\n\t100% {\n\t\topacity: 0;\n\t}\n}"],"sourceRoot":""}]);
// Exports
